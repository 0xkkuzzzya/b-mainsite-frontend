...
export const FourthBlock = () => {
    ...
    return (
        ...
        <BlockContainer marginM={inView == true ? '100px' : '150px'} opacityM={inView == true ? '1' : '0'} ref={ref}>
            ...
            <BlockText><GradientText>100%</GradientText> based on TON smart-contracts.</BlockText>
            <BlockDescription>
                Bytecoin protocol is a fair-mining smart-contracts based on TON. $BYTEis the first fully programmable community token on TON.
            </BlockDescription>
        </BlockContainer>
    )
}