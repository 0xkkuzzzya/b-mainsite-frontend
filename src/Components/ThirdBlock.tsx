...
export const ThirdBlock = () => {
    ...
    return (
        <BlockContainer marginM={inView == true ? '100px' : '150px'} opacityM={inView == true ? '1' : '0'} ref={ref}>
            ...
            <BlockText>Not your average TON memecoin.</BlockText>
            <BlockDescription>$BYTEis the most fair token on TON blockchain. No team allocation, no insiders, no whales.</BlockDescription>
        </BlockContainer>
    )
}